  ...
  <div class="space-y-8">
    ...
    <div v-else class="space-y-8">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <UiCard variant="default" padding="lg" class="border-zinc-800 bg-zinc-950/80 space-y-4 flex flex-col justify-between">
          <div class="space-y-4">
            ...
            >
              <p class="text-xs text-zinc-500">No questions currently submitted in The Vault.</p>
            </div>
        ...
        <UiCard variant="default" padding="lg" class="border-zinc-800 bg-zinc-950/80 space-y-4 flex flex-col justify-between">
          <div class="space-y-4">
            ...
            <div
              ...
              class="py-10 text-center border border-dashed border-zinc-800/80 rounded-xl"
            >
              <p class="text-xs text-zinc-500">No applicants registered in the pipeline yet.</p>
            </div>
      ...
      <UiCard variant="default" padding="lg" class="border-zinc-800 bg-zinc-950/80 space-y-4">
        ...
        <div v-if="activeSchedulesList.length === 0" class="py-8 text-center text-xs text-zinc-500">
          No active schedules currently published. Click "Manage Schedules" to activate one.
        </div>
...
const { data: dashboardData, pending, refresh } = await useAsyncData('admin-live-dashboard', async () => {

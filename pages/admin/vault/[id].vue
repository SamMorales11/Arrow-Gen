<template>
  <div class="space-y-6 max-w-5xl mx-auto">
    ...
    >
      ...
      <h2 class="text-base font-semibold text-zinc-100">Inquiry Not Found</h2>
      <p class="text-xs text-zinc-400 mt-1 max-w-sm mx-auto">
        The requested question could not be found or may have been deleted.
      </p>
      <NuxtLink to="/admin/vault" class="inline-block mt-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
              ...
              >
                ...
                <div>
                  ...
                  <p class="text-[10px] text-zinc-500">Under review / prayer item</p>
                </div>
              </label>
              ...
              >
                ...
                <div>
                  ...
                  <p class="text-[10px] text-zinc-500">Resolved &amp; guidance ready</p>
                </div>
              </label>
              ...
              >
                ...
                <div>
                  ...
                  <p class="text-[10px] text-zinc-500">Inappropriate or filtered</p>
                </div>
              </label>
            </div>
          </div>

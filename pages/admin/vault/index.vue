<template>
  <div class="space-y-8">
    ...
    >
      ...
      <h3 class="text-sm font-semibold text-zinc-200">No questions found</h3>
      <p class="text-xs text-zinc-500 mt-1 max-w-sm mx-auto">
        {{ searchQuery ? 'No questions match your search criteria. Try a different keyword.' : 'There are currently no questions in this category.' }}
      </p>
      <UiButton
          ...
          <div class="space-y-1.5">
            ...
            <div class="grid grid-cols-3 gap-2">
              <button
                ...
                type="button"
                :class="[
                  'py-2 px-3 rounded-lg text-xs font-medium border text-center transition-colors uppercase tracking-wider',
                  replyForm.status === st
                    ? st === 'answered'
...
const submitReply = async () => {
  ...
  try {
    ...
    alert('Failed to save pastoral response. Please check your connection.')
  } finally {

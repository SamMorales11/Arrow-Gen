<template>
  <div class="space-y-8">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 p-4 rounded-xl bg-zinc-900/60 border border-zinc-800">
      <!-- Status Tabs Filter -->
      <div class="flex flex-wrap items-center gap-1.5 p-1 bg-zinc-950 rounded-lg border border-zinc-800/80" role="tablist" aria-label="Applicant status filters">
        <button
      ...
      <div class="w-full max-w-2xl bg-zinc-950 border border-zinc-800 rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div class="px-6 py-4 border-b border-zinc-800 flex items-center justify-between bg-zinc-900/60">
          ...
          <button
            ...
            aria-label="Close applicant dossier dialog"
        ...
        <div class="p-6 space-y-6 overflow-y-auto flex-1">
          ...
          <div class="space-y-2">
            <div class="flex items-center justify-between">
              ...
              <span class="text-[11px] text-zinc-400 font-mono">Statement of Heart</span>
            </div>
          ...
          <div class="space-y-2.5 pt-2 border-t border-zinc-900">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-2" role="group" aria-label="Application status options">
              <button
...
const submitStatusUpdate = async () => {
  ...
  closeDetailModal()
  showToast(`Applicant ${targetApplicant.fullName} status updated to "${newStatus}".`)
